      ...
      <>
        ...
        <div className="container mb-3">
          <Fade>
            ...
            <p>Welcome to Kerja.in!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Kerja.in's Website, located at .
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Kerja.in if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing Kerja.in, you agreed to
              use cookies in agreement with the Kerja.in's Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, Kerja.in and/or its licensors own the
              intellectual property rights for all material on Kerja.in. All
              intellectual property rights are reserved. You may access this
              from Kerja.in for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Kerja.in</li>
              <li>Sell, rent or sub-license material from Kerja.in</li>
              <li>Reproduce, duplicate or copy material from Kerja.in</li>
              <li>Redistribute content from Kerja.in</li>
            </ul>
            ...
            <p>
              ...
              Kerja.in does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Kerja.in,its agents and/or affiliates.
              ...
              laws, Kerja.in shall not be liable for the Comments or for any
            ...
            <p>
              Kerja.in reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant Kerja.in a non-exclusive license to use,
            ...
            <p>
              ...
              Kerja.in; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Kerja.in. Please include your name, your
            ...
            <p>
              No use of Kerja.in's logo or other artwork will be allowed for
